...
$failed_id = isset($_GET['failed_id']) ? $_GET['failed_id'] : '';
...
if ($pass_id) {
    ...
    try {
        ...
        $mail->Subject = 'เราได้ตรวจสอบการชำระเงินจากคุณเป็นที่เรียบร้อย';
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="padding: 0 2.5em; text-align: left;">
                                                <div class="text">
                                                    <h2>เราได้ตรวจสอบการชำระเงินจากคุณเป็นที่เรียบร้อย</h2>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="bg_light">
                                            <td style="padding: 0 1.5em; text-align: left;">
                                                ...
                                                <div>
                                                    <h4>เราได้ตรวจสอบการชำระเงินของคุณผ่านทาง <b>' . $data['bank_name'] . '</b> สำหรับคำสั่งซื้อ <b>#' . $data['order_id'] . '</b> เป็นที่เรียบร้อย คุณจะได้รับอีเมลล์อีกครั้งเมื่อสินค้าของคุณได้รับการจัดส่ง</h4>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
    ...
    ' . $footer . '
	 ';
        ...
        echo "window.location = 'admin/admin.php?nextpage=report&page=order_check'; ";
        echo "</script>";
    } catch (Exception $e) {
    ...
    try {
        ...
        $mail->isHTML(true);                                  // Set email format to HTML
        $mail->CharSet = PHPMailer::CHARSET_UTF8;
        $mail->Subject = 'การชำระเงินของคุณไม่สำเร็จ';
                                ...
                                <td valign="middle" class="hero bg_white" style="padding: 2em 0 2em 0;">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="padding: 0 2.5em; text-align: left;">
                                                <div class="text">
                                                    <h2>การชำระเงินของคุณไม่สำเร็จ</h2>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="bg_light">
                                            <td style="padding: 0 1.5em; text-align: left;">
                                                ...
                                                <div>
                                                    <h4>การชำระเงินของคุณผ่านทาง <b>' . $data['bank_name'] . '</b> สำหรับคำสั่งซื้อ <b>#' . $data['order_id'] . '</b> ไม่สำเร็จ</h4>
                                                </div>
                                                <div>
                                                    <h4><b style="color:red;">หมายเหตุ</b> <b>' . $data['comment'] . '</b> กรุณาตรวจสอบการชำระเงินของคุณ</h4>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
