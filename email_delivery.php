...
try {
    ...
    $mail->Subject = 'ร้านค้าส่งมอบสินค้าให้บริษัทขนส่งแล้ว';
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="padding: 0 2.5em; text-align: left;">
                                                <div class="text">
                                                    <h2>ร้านค้าส่งมอบสินค้าให้บริษัทขนส่งแล้ว</h2>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="bg_light">
                                            <td style="padding: 0 1.5em; text-align: left;">
                                                ...
                                                <div>
                                                    <h4>บริษัทขนส่งได้รับสินค้าจากร้านค้าเรียบร้อยแล้วสำหรับคำสั่งซื้อ<b>#' . $data['order_id'] . '</b></h4>
                                                    <h2 align="center">หมายเลขพัสดุ :</h2>
                                                    <h2 align="center">' . $data['tracking_number'] . '</h2>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
    ...
    echo "window.location = 'admin/admin.php?nextpage=report&page=order_delivery'; ";
    echo "</script>";
} catch (Exception $e) {
