...
$sql = "SELECT * from  `order` where user_id =  $user_id and order_status = 'กำลังเตรียมจัดส่ง' ORDER BY order_id ASC";
...
?>
    ...
    <div class="row mb-1 text-center" style="background-color:#fff;align-items: center;">
        ...
        <div class="col-2 p-0">
            <a href="user.php?nextpage=manage&page=order_detail&pageback=order_delivery&id=<?php echo $data["order_id"] ?>"> <button class="btn_delivery">กำลังเตรียมจัดส่ง</button></a>
        </div>
