...
$sql = "SELECT * from  `order` where user_id =  $user_id and (order_status = 'ชำระเงินไม่สำเร็จ') ORDER BY order_id ASC";
...
?>
    ...
    <div class="row mb-1 text-center" style="background-color:#fff;align-items: center;">
        ...
        <div class="col-2 p-0">
            <a href="user.php?nextpage=manage&page=order_detail&pageback=order_paymentfailed&id=<?php echo $data["order_id"] ?>" > <button class="btn_bill">ชำระเงิน</button></a>
        </div>
